<template>
  <div :class="wrapperClasses" v-click-outside="handleClose">
    <div :class="[prefixCls + '-rel']">
      <input :value="value" :class="[prefixCls + '-input']" @click.native="handleFocus" @focus="handleFocus" />
    </div>
      ...
      <div v-show="visible" :class="classes">
        <div :class="datePickerPanelClasses">
          <div :class="[datePickerPanelClasses + '-header']">
            ...
            <span class="pre-month-btn">‹</span>
            <span class="text">2018年</span>
            <span class="text">3月</span>
